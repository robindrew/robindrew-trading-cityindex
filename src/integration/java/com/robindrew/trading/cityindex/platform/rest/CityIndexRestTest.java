...
import static com.robindrew.trading.cityindex.platform.streaming.prices.PriceUpdateFields.parseTimestamp;
...
public class CityIndexRestTest {
	...
	class MyTableListener implements HandyTableListener {
		...
		public void onUpdate(int arg0, String arg1, UpdateInfo info) {
			...
			long timestamp = parseTimestamp(info.getNewValue(FIELD_TICK_DATE));
