...
public class CityIndexInstrument extends Instrument implements ICityIndexInstrument {
	...
	/** AUD/USD. */
	public static final CityIndexInstrument SPOT_AUD_USD = new CityIndexInstrument(400616153, DFT, AUD_USD, 5);
	/** EUR/JPY. */
	public static final CityIndexInstrument SPOT_EUR_JPY = new CityIndexInstrument(400616147, DFT, EUR_JPY, 5);
	/** EUR/USD. */
	public static final CityIndexInstrument SPOT_EUR_USD = new CityIndexInstrument(400616149, DFT, EUR_USD, 5);
	/** GBP/USD. */
	public static final CityIndexInstrument SPOT_GBP_USD = new CityIndexInstrument(400616150, DFT, GBP_USD, 5);
	/** USD/CHF. */
	public static final CityIndexInstrument SPOT_USD_CHF = new CityIndexInstrument(400616148, DFT, USD_CHF, 5);
	/** USD/JPY. */
	public static final CityIndexInstrument SPOT_USD_JPY = new CityIndexInstrument(400616151, DFT, USD_JPY, 5);

	/** Bitcoin. */
	public static final CityIndexInstrument SPOT_BITCOIN = new CityIndexInstrument(401379436, DFT, BITCOIN, 1);
	/** Ether. */
	public static final CityIndexInstrument SPOT_ETHER = new CityIndexInstrument(401497467, DFT, ETHER, 1);
	/** Ripple. */
	public static final CityIndexInstrument SPOT_RIPPLE = new CityIndexInstrument(401497526, DFT, RIPPLE, 3);
	/** Litecoin. */
	public static final CityIndexInstrument SPOT_LITECOIN = new CityIndexInstrument(401497517, DFT, LITECOIN, 1);

	/** FTSE 100. */
	public static final CityIndexInstrument SPOT_FTSE_100 = new CityIndexInstrument(400616113, DFT, FTSE_100, 1);
	/** DAX. */
	public static final CityIndexInstrument SPOT_DAX = new CityIndexInstrument(400616115, DFT, DAX_30, 1);
	/** S&amp;P 500. */
	public static final CityIndexInstrument SPOT_SP_500 = new CityIndexInstrument(400616141, DFT, SP_500, 1);
	/** DOW JONES. */
	public static final CityIndexInstrument SPOT_DOW_JONES = new CityIndexInstrument(400616114, DFT, DOW_JONES_30, 1);

	/** GOLD. */
	public static final CityIndexInstrument SPOT_GOLD = new CityIndexInstrument(400616377, DFT, XAU_USD, 1);
	/** SILVER. */
	public static final CityIndexInstrument SPOT_SILVER = new CityIndexInstrument(400616380, DFT, XAG_USD, 1);
